...
import com.orange.sudoku.domain.getHash
...
class ActiveGameViewModel {
    ...
    fun initializeBoardState(
        ...
        if (isComplete) {
            ...
            contentState = ActiveGameState.COMPLETE
        } else {
            contentState = ActiveGameState.ACTIVE
        }
    ...
    internal fun showLoadingState() {
        subContentState?.invoke(ActiveGameScreenStae.LOADING)
    }
